...
public class ColorPickerUtil extends FrameLayout implements View.OnClickListener {
    ...
    public interface OnColorSelectedListener {
        ...
        /**
         * Called when a specific color circle has been selected.
         */
        void onColorSelected(int color);
    }

    public ColorPickerUtil(Context context, int color, boolean checked,
